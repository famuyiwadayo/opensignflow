...
Use a Turborepo monorepo with Bun workspaces.
...
```txt
packages/shared      generic API primitives, ID prefixes, small constants
...
Type ownership and shared-package boundaries were refined later in [ADR 0005](./0005-backend-contract-and-type-ownership.md).
